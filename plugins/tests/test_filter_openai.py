...
from filter_openai.config import FilterOpenAiConfig  # noqa: E402
from filter_openai.filter_openai import FilterOpenai  # noqa: E402
...
def test_custom_filter_with_api_call(mock_post, filter_openai_plugin, test_image):
    ...
    with patch("builtins.open", mock_open(read_data="my custom test prompt")):
